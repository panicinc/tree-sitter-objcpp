...
module.exports = grammar(OBJC, {
  ...
  rules: {
    ...
    _type_specifier: $ => choice(
      alias($._struct_specifier, $.struct_specifier),
      alias($._union_specifier, $.union_specifier),
      alias($._enum_specifier, $.enum_specifier),
      $.class_specifier,
    ...
    _union_specifier: $ => prec.right(seq(
      'union',
      optional($.ms_declspec_modifier),
      optional($.attribute_declaration),
      choice(
    ...
    _struct_specifier: $ => prec.right(seq(
      'struct',
      optional($.ms_declspec_modifier),
      optional($.attribute_declaration),
      choice(
    ...
    _non_case_statement: ($, original) => choice(
      ...
      $.for_range_loop,
      $.try_statement,
      alias($._throw_statement, $.throw_statement),
    ),
